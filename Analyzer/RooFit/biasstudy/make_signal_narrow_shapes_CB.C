...
void make_signal_narrow_shapes(int signalmass = 700, int yhi = 900)
{
  ...
  RooRealVar* sigma = new RooRealVar("sigma","sigma",30,0,50,"");
  RooRealVar* n = new RooRealVar("n","n",0.1,0,2,"");
