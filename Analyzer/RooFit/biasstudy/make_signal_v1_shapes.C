...
void make_signal_v1_shapes(int signalmass = 800)
{
  ...
  // --- Create obervable --- 
  RooRealVar *x = new RooRealVar("m","invmass",600,2800,""); //the name "m" will be used by RooDataSet to import data
  x->setBins(110);
  ...
  RooFitResult *r = model->fitTo(data,Range(signalmass*0.7, signalmass*1.3),RooFit::Minimizer("Minuit2"),Save());
