...
void make_signal_wide_shapes_CB2Gaus(int signalmass = 6000, int yhi = 400)
{
  ...
  RooRealVar* CB_alpha = new RooRealVar("CB_alpha","CB_alpha",0.6,0.50,1,"");
  RooRealVar* CB_n = new RooRealVar("CB_n","CB_n",2.5,2,3,"");
  ...
  RooRealVar* Gaus_sigma_1 = new RooRealVar("Gaus_sigma_1","Gaus_sigma_1",180,150,200,"");
  ...
  RooRealVar* Gaus_sigma_2 = new RooRealVar("Gaus_sigma_2","Gaus_sigma_2",300,200,400,"");
  ...
  RooRealVar* frac2 = new RooRealVar("frac2","frac2",0.8,0.6,0.85);
