...
void make_signal_wide_shapes_CB2Gaus(int signalmass = 5000, int yhi = 200)
{
  ...
  RooRealVar* CB_sigma = new RooRealVar("CB_sigma","CB_sigma",180,172.36,200,"");
  RooRealVar* CB_alpha = new RooRealVar("CB_alpha","CB_alpha",1.25,0.5,2,"");
  ...
  RooRealVar* Gaus_sigma_1 = new RooRealVar("Gaus_sigma_1","Gaus_sigma_1",300,200,500,"");
  ...
  RooRealVar* frac1 = new RooRealVar("frac1","frac1",0.8,0.6,0.9);
