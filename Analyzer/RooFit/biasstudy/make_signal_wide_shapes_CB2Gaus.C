...
void make_signal_wide_shapes_CB2Gaus(int signalmass = 2000, int yhi = 500)
{
  ...
  RooRealVar* CB_sigma = new RooRealVar("CB_sigma","CB_sigma",82.99,81,83.62,"");
  RooRealVar* CB_alpha = new RooRealVar("CB_alpha","CB_alpha",1,0.5,1.5,"");
  RooRealVar* CB_n = new RooRealVar("CB_n","CB_n",2.03,1.95,2.05,"");
  ...
  RooRealVar* Gaus_sigma_1 = new RooRealVar("Gaus_sigma_1","Gaus_sigma_1",92,90,93.13,"");
