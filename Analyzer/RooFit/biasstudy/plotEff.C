...
void plotEff(){
  ...
  //16 madrgaph
  double narrow[15] = {0.1577,0.15605,0.15725,0.15345,0.15585,0.15295,0.1475,0.141,0.1346,0.13795,0.12985,0.12885,0.12255,0.1204,0.12225};
  double massn[15] = {700,800,900,1000,1200,1400,1600,1800,2000,2200,2400,2600,2800,3000,3500};
  double wide[14] = {0.14745,0.14465,0.14995,0.1511,0.1465,0.145,0.13855,0.13865,0.12635,0.1232,0.12605,0.1106,0.10995,0.104};
  ...
  //17 madrgaph
  // double narrow[14] = {0.1653,0.16855,0.17,0.17315,0.16805,0.16445,0.16315,0.14365,0.1435,0.14105,0.1347,0.1391,0.1307,0.12895};
  // double massn[14] = {700,800,900,1000,1200,1400,1600,2000,2200,2400,2600,2800,3000,3500};
  // double wide[14] = {0.1632,0.16295,0.1662,0.1712,0.1571,0.1581,0.15045,0.1507,0.13965,0.1364,0.1307,0.12585,0.12085,0.107};
  ...
  TGraph *gr1 = new TGraph(14,&massn[0],&narrow[0]);
  ...
  TGraph *gr2 = new TGraph(14,&massw[0],&wide[0]);
