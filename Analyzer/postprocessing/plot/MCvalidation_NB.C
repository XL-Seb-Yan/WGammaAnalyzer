...
void MCvalidation_NB()
{
  ...
  TH1 *hist12 = new TH1F("12","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist13 = new TH1F("13","pt_{j}",70,0,2800);
  TH1 *hist14 = new TH1F("14","eta_{j}",60,-3,3);
  ...
  TH1 *hist110 = new TH1F("110","invariant mass",112,400,6000);
  TH1 *hist111 = new TH1F("111","seperation",50,0,8);
  TH1 *hist21 = new TH1F("21","pt_{#gamma}",70,0,2800);
  TH1 *hist22 = new TH1F("22","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist23 = new TH1F("23","pt_{j}",70,0,2800);
  TH1 *hist24 = new TH1F("24","eta_{j}",60,-3,3);
  ...
  TH1 *hist210 = new TH1F("210","invariant mass",112,400,6000);
  TH1 *hist211 = new TH1F("211","seperation",50,0,8);
  TH1 *hist31 = new TH1F("31","pt_{#gamma}",70,0,2800);
  TH1 *hist32 = new TH1F("32","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist33 = new TH1F("33","pt_{j}",70,0,2800);
  TH1 *hist34 = new TH1F("34","eta_{j}",60,-3,3);
  ...
  TH1 *hist310 = new TH1F("310","invariant mass",112,400,6000);
  TH1 *hist311 = new TH1F("311","seperation",50,0,8);
  TH1 *hist3a1 = new TH1F("3a1","pt_{#gamma}",70,0,2800);
  TH1 *hist3a2 = new TH1F("3a2","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist3a3 = new TH1F("3a3","pt_{j}",70,0,2800);
  TH1 *hist3a4 = new TH1F("3a4","eta_{j}",60,-3,3);
  ...
  TH1 *hist3a10 = new TH1F("3a10","invariant mass",112,400,6000);
  TH1 *hist3a11 = new TH1F("3a11","seperation",50,0,8);
  TH1 *hist41 = new TH1F("41","pt_{#gamma}",70,0,2800);
  TH1 *hist42 = new TH1F("42","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist43 = new TH1F("43","pt_{j}",70,0,2800);
  TH1 *hist44 = new TH1F("44","eta_{j}",60,-3,3);
  ...
  TH1 *hist410 = new TH1F("410","invariant mass",112,400,6000);
  TH1 *hist411 = new TH1F("411","seperation",50,0,8);
  TH1 *hist51 = new TH1F("51","pt_{#gamma}",70,0,2800);
  TH1 *hist52 = new TH1F("52","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist53 = new TH1F("53","pt_{j}",70,0,2800);
  TH1 *hist54 = new TH1F("54","eta_{j}",60,-3,3);
  ...
  TH1 *hist510 = new TH1F("510","invariant mass",112,400,6000);
  TH1 *hist511 = new TH1F("511","seperation",50,0,8);
  TH1 *hist61 = new TH1F("61","pt_{#gamma}",70,0,2800);
  TH1 *hist62 = new TH1F("62","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist63 = new TH1F("63","pt_{j}",70,0,2800);
  TH1 *hist64 = new TH1F("64","eta_{j}",60,-3,3);
  ...
  TH1 *hist610 = new TH1F("610","invariant mass",112,400,6000);
  TH1 *hist611 = new TH1F("611","seperation",50,0,8);
  TH1 *hist71 = new TH1F("71","pt_{#gamma}",70,0,2800);
  TH1 *hist72 = new TH1F("72","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist73 = new TH1F("73","pt_{j}",70,0,2800);
  TH1 *hist74 = new TH1F("74","eta_{j}",60,-3,3);
  ...
  TH1 *hist710 = new TH1F("710","invariant mass",112,400,6000);
  TH1 *hist711 = new TH1F("711","seperation",50,0,8);
  TH1 *hist81 = new TH1F("81","pt_{#gamma}",70,0,2800);
  TH1 *hist82 = new TH1F("82","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist83 = new TH1F("83","pt_{j}",70,0,2800);
  TH1 *hist84 = new TH1F("84","eta_{j}",60,-3,3);
  ...
  TH1 *hist810 = new TH1F("810","invariant mass",112,400,6000);
  TH1 *hist811 = new TH1F("811","seperation",50,0,8);
  TH1 *hist91 = new TH1F("91","pt_{#gamma}",70,0,2800);
  TH1 *hist92 = new TH1F("92","eta_{#gamma}",50,-2.5,2.5);
  TH1 *hist93 = new TH1F("93","pt_{j}",70,0,2800);
  TH1 *hist94 = new TH1F("94","eta_{j}",60,-3,3);
  ...
  TH1 *hist910 = new TH1F("910","invariant mass",112,400,6000);
  ...
  for (int ievt = 0; ievt<theTree->GetEntries();ievt++) {
    ...
    p.SetPtEtaPhiE(p_pt, p_eta, p_phi, p_e);
    j.SetPtEtaPhiE(j_pt, j_eta, j_phi, j_e);
    hist512->Fill((p+j).Pt(), 0.0343 * x_sf * x_puweight);     
  }
  cout<<hist56->GetSumOfWeights()<<endl;

  input = TFile::Open("/afs/cern.ch/work/x/xuyan/work5/PROD17/DATA/spin-0_scalar_21Mar23/presel/3500_N_postproc_WGamma17_full_full_jmcorr_Mar23.root");
  theTree = (TTree*)input->Get("Events");
  // Improt variables for cutting
  theTree->SetBranchAddress("photon_pt", &p_pt);
  theTree->SetBranchAddress("photon_eta", &p_eta);
  ...
  for (int ievt = 0; ievt<theTree->GetEntries();ievt++) {
    ...
    input = TFile::Open("/afs/cern.ch/work/x/xuyan/work5/PROD17/DATA/spin-0_scalar_21Mar23/presel/3500_W_postproc_WGamma17_full_full_jmcorr_Mar23.root");
  theTree = (TTree*)input->Get("Events");
  // Improt variables for cutting
  theTree->SetBranchAddress("photon_pt", &p_pt);
  theTree->SetBranchAddress("photon_eta", &p_eta);
  ...
  hist51->SetLineColor(sig_col_1);
  hist52->SetLineColor(sig_col_1);
  hist53->SetLineColor(sig_col_1);
  hist54->SetLineColor(sig_col_1);
  hist55->SetLineColor(sig_col_1);
  hist56->SetLineColor(sig_col_1);
  hist57->SetLineColor(sig_col_1);
  hist58->SetLineColor(sig_col_1);
  hist59->SetLineColor(sig_col_1);
  hist510->SetLineColor(sig_col_1);
  hist511->SetLineColor(sig_col_1);
  hist512->SetLineColor(sig_col_1);
  hist61->SetLineColor(sig_col_2);
  hist62->SetLineColor(sig_col_2);
  hist63->SetLineColor(sig_col_2);
  hist64->SetLineColor(sig_col_2);
  hist65->SetLineColor(sig_col_2);
  hist66->SetLineColor(sig_col_2);
  hist67->SetLineColor(sig_col_2);
  hist68->SetLineColor(sig_col_2);
  hist69->SetLineColor(sig_col_2);
  hist610->SetLineColor(sig_col_2);
  hist611->SetLineColor(sig_col_2);
  hist612->SetLineColor(sig_col_2);
  ...
  hist62->SetLineStyle(1);
  hist63->SetLineStyle(1);
  hist64->SetLineStyle(1);
  hist65->SetLineStyle(1);
  hist66->SetLineStyle(1);
  hist67->SetLineStyle(1);
  hist68->SetLineStyle(1);
  hist69->SetLineStyle(1);
  hist610->SetLineStyle(1);
  hist611->SetLineStyle(1);
  hist612->SetLineStyle(1);
  hist71->SetLineStyle(3);
  hist72->SetLineStyle(3);
  hist73->SetLineStyle(3);
  hist74->SetLineStyle(3);
  hist75->SetLineStyle(3);
  hist76->SetLineStyle(3);
  hist77->SetLineStyle(3);
  hist78->SetLineStyle(3);
  hist79->SetLineStyle(3);
  hist710->SetLineStyle(3);
  hist711->SetLineStyle(3);
  hist712->SetLineStyle(3);
  ...
  legend->AddEntry(hist41,"Sig. 1.0 TeV, #Gamma_{X} / m_{X} = 0.01%");
  legend->AddEntry(hist51,"Sig. 1.0 TeV, #Gamma_{X} / m_{X} = 5%");
  legend->AddEntry(hist61,"Sig. 3.5 TeV, #Gamma_{X} / m_{X} = 0.01%");
  legend->AddEntry(hist71,"Sig. 3.5 TeV, #Gamma_{X} / m_{X} = 5%");
  ...
  //===========================================================
  TCanvas *c05 = new TCanvas("c05","",5000,4500);
  c05->cd();
