...
void compare_plot_3()
{
  ...
  TFile *input = TFile::Open("/afs/cern.ch/work/x/xuyan/work5/PROD17/DATA/2017/ntuples_looseID/SignalMC1000N_nominal_pileup_WGamma_full_full_May22.root");
  ...
  input = TFile::Open("/afs/cern.ch/work/x/xuyan/work5/PROD17/DATA/2017/ntuples_looseID/SignalMC3000N_nominal_pileup_WGamma_full_full_May22.root");
  ...
  input = TFile::Open("/afs/cern.ch/work/x/xuyan/work5/PROD17/DATA/2017/ntuples_looseID/SignalMC5000N_nominal_pileup_WGamma_full_full_May22.root");
  theTree = (TTree*)input->Get("Events");
  // Improt variables for cutting
  theTree->SetBranchAddress("photon_pt", &p_pt);
  theTree->SetBranchAddress("photon_eta", &p_eta);
  ...
  hist31->SetLineColor(color3);
  hist32->SetLineColor(color3);
  hist33->SetLineColor(color3);
  hist34->SetLineColor(color3);
  hist35->SetLineColor(color3);
  hist36->SetLineColor(color3);
  hist37->SetLineColor(color3);
  hist38->SetLineColor(color3);
  hist39->SetLineColor(color3);
  hist310->SetLineColor(color3);
  hist311->SetLineColor(color3);
  ...
  hist31->SetLineWidth(3);
  hist32->SetLineWidth(3);
  hist33->SetLineWidth(3);
  hist34->SetLineWidth(3);
  hist35->SetLineWidth(3);
  hist36->SetLineWidth(3);
  hist37->SetLineWidth(3);
  hist38->SetLineWidth(3);
  ...
  c01->cd();
  TPad *p01a = new TPad("p01a","p01a",0,0.30,1,1.0);
  TPad *p01b = new TPad("p01b","p01b",0,0.19,1,0.38);
  TPad *p01c = new TPad("p01b","p01b",0,0,1,0.19);
  p01a->Draw();
  p01b->Draw();
  p01c->Draw();
  p01a->cd();
  ...
  legend->Clear();
  legend->AddEntry(hist11,"SinglePhoton 2016","f");
  legend->AddEntry(hist21,"SinglePhoton 2017","f");
  legend->AddEntry(hist31,"EGamma 2018","f");
  legend->Draw();
  ...
  yaxisadd1->SetTitle("2016 / 2017");
  yaxisadd1->SetTitleOffset(0.3);
  ...
  p01c->cd();
  p01c->SetTopMargin(0.1);
  p01c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist31->Clone();
  main = (TH1*)hist21->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("pt_{#gamma} (GeV)");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  xaxisadd2->SetLabelSize(0.1);
  xaxisadd2->SetTitleSize(0.1);
  yaxisadd2->SetLabelSize(0.1);
  yaxisadd2->SetNdivisions(5);
  yaxisadd2->SetTitleSize(0.1);
  p01c->SetGrid();
  //pull2->SetFillColor(kViolet);
  //pull2->SetLineColor(kViolet);
  //pull2->SetFillColorAlpha(kViolet, 0.35);
  pull2->Draw("PE1");
  //pull2->Draw("BAR HIST");
  c01->Print("p_pt.png");
  c01->Print("p_pt.pdf");
  ...
  c02->cd();
  TPad *p02a = new TPad("p02a","p02a",0,0.30,1,1.0);
  TPad *p02b = new TPad("p02b","p02b",0,0.19,1,0.38);
  TPad *p02c = new TPad("p02b","p02b",0,0,1,0.19);
  p02a->Draw();
  p02b->Draw();
  p02c->Draw();
  p02a->cd();
  ...
  p02c->cd();
  p02c->SetTopMargin(0.1);
  p02c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist32->Clone();
  main = (TH1*)hist22->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("#eta_{#gamma}");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c03->cd();
  TPad *p03a = new TPad("p03a","p03a",0,0.30,1,1.0);
  TPad *p03b = new TPad("p03b","p03b",0,0.19,1,0.38);
  TPad *p03c = new TPad("p03b","p03b",0,0,1,0.19);
  p03a->Draw();
  p03b->Draw();
  p03c->Draw();
  p03a->cd();
  ...
  p03c->cd();
  p03c->SetTopMargin(0.1);
  p03c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist33->Clone();
  main = (TH1*)hist23->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("pt_{j} (GeV)");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c04->cd();
  TPad *p04a = new TPad("p04a","p04a",0,0.30,1,1.0);
  TPad *p04b = new TPad("p04b","p04b",0,0.19,1,0.38);
  TPad *p04c = new TPad("p04b","p04b",0,0,1,0.19);
  p04a->Draw();
  p04b->Draw();
  p04c->Draw();
  p04a->cd();
  ...
  p04c->cd();
  p04c->SetTopMargin(0.1);
  p04c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist34->Clone();
  main = (TH1*)hist24->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("#eta_{j}");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c05->cd();
  TPad *p05a = new TPad("p05a","p05a",0,0.30,1,1.0);
  TPad *p05b = new TPad("p05b","p05b",0,0.19,1,0.38);
  TPad *p05c = new TPad("p05b","p05b",0,0,1,0.19);
  p05a->Draw();
  p05b->Draw();
  p05c->Draw();
  p05a->cd();
  ...
  p05c->cd();
  p05c->SetTopMargin(0.1);
  p05c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist35->Clone();
  main = (TH1*)hist25->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("E_{j} (GeV)");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c06->cd();
  TPad *p06a = new TPad("p06a","p06a",0,0.30,1,1.0);
  TPad *p06b = new TPad("p06b","p06b",0,0.19,1,0.38);
  TPad *p06c = new TPad("p06b","p06b",0,0,1,0.19);
  p06a->Draw();
  p06b->Draw();
  p06c->Draw();
  p06a->cd();
  ...
  legend->AddEntry(hist21,"2017 signal MC M-3000","f");
  legend->AddEntry(hist31,"2017 signal MC M-5000","f");
  legend->Draw();
  ...
  p06c->cd();
  p06c->SetTopMargin(0.1);
  p06c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist36->Clone();
  main = (TH1*)hist26->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("SD m_{j} (GeV)");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  */
  ...
  c07->cd();
  TPad *p07a = new TPad("p07a","p07a",0,0.30,1,1.0);
  TPad *p07b = new TPad("p07b","p07b",0,0.19,1,0.38);
  TPad *p07c = new TPad("p07b","p07b",0,0,1,0.19);
  p07a->Draw();
  p07b->Draw();
  p07c->Draw();
  p07a->cd();
  ...
  p07c->cd();
  p07c->SetTopMargin(0.1);
  p07c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist37->Clone();
  main = (TH1*)hist27->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("#tau21_{j}");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c08->cd();
  TPad *p08a = new TPad("p08a","p08a",0,0.30,1,1.0);
  TPad *p08b = new TPad("p08b","p08b",0,0.19,1,0.38);
  TPad *p08c = new TPad("p08b","p08b",0,0,1,0.19);
  p08a->Draw();
  p08b->Draw();
  p08c->Draw();
  p08a->cd();
  ...
  p08c->cd();
  p08c->SetTopMargin(0.1);
  p08c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist38->Clone();
  main = (TH1*)hist28->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("cos(#theta*)");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c09->cd();
  TPad *p09a = new TPad("p09a","p09a",0,0.30,1,1.0);
  TPad *p09b = new TPad("p09b","p09b",0,0.19,1,0.38);
  TPad *p09c = new TPad("p09b","p09b",0,0,1,0.19);
  p09a->Draw();
  p09b->Draw();
  p09c->Draw();
  p09a->cd();
  ...
  p09c->cd();
  p09c->SetTopMargin(0.1);
  p09c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist39->Clone();
  main = (TH1*)hist29->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("pt_{#gamma} / M_{j#gamma}");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c10->cd();
  TPad *p10a = new TPad("p10a","p10a",0,0.30,1,1.0);
  TPad *p10b = new TPad("p10b","p10b",0,0.19,1,0.38);
  TPad *p10c = new TPad("p10b","p10b",0,0,1,0.19);
  p10a->Draw();
  p10b->Draw();
  p10c->Draw();
  p10a->cd();
  ...
  p10c->cd();
  p10c->SetTopMargin(0.1);
  p10c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist310->Clone();
  main = (TH1*)hist210->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("M_{j#gamma} (GeV)");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
  ...
  c11->cd();
  TPad *p11a = new TPad("p11a","p11a",0,0.30,1,1.0);
  TPad *p11b = new TPad("p11b","p11b",0,0.19,1,0.38);
  TPad *p11c = new TPad("p11b","p11b",0,0,1,0.19);
  p11a->Draw();
  p11b->Draw();
  p11c->Draw();
  p11a->cd();
  ...
  p11c->cd();
  p11c->SetTopMargin(0.1);
  p11c->SetBottomMargin(0.3);
  pull2 = (TH1*)hist311->Clone();
  main = (TH1*)hist211->Clone();
  pull2->Divide(main);
  xaxisadd2 = pull2->GetXaxis();
  yaxisadd2 = pull2->GetYaxis();
  xaxisadd2->SetTitle("#gamma MVA ID");
  xaxisadd2->SetTitleOffset(1.25);
  yaxisadd2->SetTitle("2018 / 2017");
  yaxisadd2->SetTitleOffset(0.3);
  yaxisadd2->SetRangeUser(0,2);
