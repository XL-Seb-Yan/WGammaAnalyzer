...
void MCvalidation()
{
  ...
  // signal
  hist41->SetLineColor(kMagenta+1);
  hist42->SetLineColor(kMagenta+1);
  hist43->SetLineColor(kMagenta+1);
  hist44->SetLineColor(kMagenta+1);
  hist45->SetLineColor(kMagenta+1);
  hist46->SetLineColor(kMagenta+1);
  hist47->SetLineColor(kMagenta+1);
  hist48->SetLineColor(kMagenta+1);
  hist49->SetLineColor(kMagenta+1);
  hist410->SetLineColor(kMagenta+1);
  hist411->SetLineColor(kMagenta+1);
  hist51->SetLineColor(kMagenta+1);
  hist52->SetLineColor(kMagenta+1);
  hist53->SetLineColor(kMagenta+1);
  hist54->SetLineColor(kMagenta+1);
  hist55->SetLineColor(kMagenta+1);
  hist56->SetLineColor(kMagenta+1);
  hist57->SetLineColor(kMagenta+1);
  hist58->SetLineColor(kMagenta+1);
  hist59->SetLineColor(kMagenta+1);
  hist510->SetLineColor(kMagenta+1);
  hist511->SetLineColor(kMagenta+1);
  hist61->SetLineColor(kPink+1);
  hist62->SetLineColor(kPink+1);
  hist63->SetLineColor(kPink+1);
  hist64->SetLineColor(kPink+1);
  hist65->SetLineColor(kPink+1);
  hist66->SetLineColor(kPink+1);
  hist67->SetLineColor(kPink+1);
  hist68->SetLineColor(kPink+1);
  hist69->SetLineColor(kPink+1);
  hist610->SetLineColor(kPink+1);
  hist611->SetLineColor(kPink+1);
  hist71->SetLineColor(kPink+1);
  hist72->SetLineColor(kPink+1);
  hist73->SetLineColor(kPink+1);
  hist74->SetLineColor(kPink+1);
  hist75->SetLineColor(kPink+1);
  hist76->SetLineColor(kPink+1);
  hist77->SetLineColor(kPink+1);
  hist78->SetLineColor(kPink+1);
  hist79->SetLineColor(kPink+1);
  hist710->SetLineColor(kPink+1);
  hist711->SetLineColor(kPink+1);
  ...
  hist41->SetLineStyle(7);
  hist42->SetLineStyle(7);
  hist43->SetLineStyle(7);
  hist44->SetLineStyle(7);
  hist45->SetLineStyle(7);
  hist46->SetLineStyle(7);
  hist47->SetLineStyle(7);
  hist48->SetLineStyle(7);
  hist49->SetLineStyle(7);
  hist410->SetLineStyle(7);
  hist411->SetLineStyle(7);
  ...
  hist61->SetLineStyle(7);
  hist62->SetLineStyle(7);
  hist63->SetLineStyle(7);
  hist64->SetLineStyle(7);
  hist65->SetLineStyle(7);
  hist66->SetLineStyle(7);
  hist67->SetLineStyle(7);
  hist68->SetLineStyle(7);
  hist69->SetLineStyle(7);
  hist610->SetLineStyle(7);
  hist611->SetLineStyle(7);
  ...
  hist81->SetLineStyle(7);
  hist82->SetLineStyle(7);
  hist83->SetLineStyle(7);
  hist84->SetLineStyle(7);
  hist85->SetLineStyle(7);
  hist86->SetLineStyle(7);
  hist87->SetLineStyle(7);
  hist88->SetLineStyle(7);
  hist89->SetLineStyle(7);
  hist810->SetLineStyle(7);
  hist811->SetLineStyle(7);
  ...
  TLegend *legend = new TLegend(0.59,0.72,0.92,0.87);
  ...
  p01b->SetGrid();
  //pull->SetFillColor(kPink+1);
  //pull->SetLineColor(kPink+1);
