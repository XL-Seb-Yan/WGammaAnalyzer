...
void plotEff(){
  ...
  // gr1->SetMarkerColor(kPink+9);
  // gr1->SetMarkerStyle(20);
  // gr1->SetMarkerSize(2.8);
  // gr1->SetLineWidth(2);
  // gr1->SetLineColor(kPink+9);
