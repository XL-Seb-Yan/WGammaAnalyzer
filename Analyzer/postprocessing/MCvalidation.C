...
void MCvalidation()
{
  ...
  TH1 *hist16 = new TH1F("16","masssoftdrop_{j}",90,30,120);
  ...
  TH1 *hist26 = new TH1F("26","masssoftdrop_{j}",90,30,120);
  ...
  TH1 *hist36 = new TH1F("36","masssoftdrop_{j}",90,30,120);
  ...
  TH1 *hist3a6 = new TH1F("3a6","masssoftdrop_{j}",90,30,120);
  ...
  TH1 *hist46 = new TH1F("46","masssoftdrop_{j}",90,30,120);
  ...
  TH1 *hist56 = new TH1F("56","masssoftdrop_{j}",90,30,120);
  ...
  TH1 *hist66 = new TH1F("66","masssoftdrop_{j}",90,30,120);
  ...
  TH1 *hist76 = new TH1F("76","masssoftdrop_{j}",90,30,120);
  ...
  c03->cd();
  TPad *p03a = new TPad("p03a","p03a",0,0.20,1,1.0);
  TPad *p03c = new TPad("p03b","p03b",0,0,1,0.20);
  TPad *p03b = new TPad("p03c","p03c",0,0,1,0.20);
  p03a->Draw();
  //p03b->Draw();
  p03c->Draw();
  p03a->cd();
  ...
  xaxis1->SetTitleOffset(1.1);
  yaxis1->SetTitleOffset(1.75);
  yaxis1->SetRangeUser(0.1,20000);
  hist36->Draw("PE1");
