void TMVApplicationS( )
{
  ...
  // Create output file
  TFile *outFile = TFile::Open("InvMassS.root", "RECREATE");
  ...
  TFile *input = TFile::Open("/afs/cern.ch/work/x/xuyan/work4/CMSSW_8_0_27/src/MCFlat/ntuples/dstau_Tau3Mu_select_MRC3.root");
