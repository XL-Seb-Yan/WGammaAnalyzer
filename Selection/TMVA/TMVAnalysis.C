void TMVAnalysis( )
{
  ...
  TCut cut_s = "(sys_invmass > 600 && sys_invmass < 1000) && (ak8puppijet_masssoftdropcorr > 65 && ak8puppijet_masssoftdropcorr < 95)";
  TCut cut_b = "(sys_invmass > 600 && sys_invmass < 1000) && (ak8puppijet_masssoftdropcorr > 50 && ak8puppijet_masssoftdropcorr < 65)";
