...
void TriggerEff(TString era = "All"){
  ...
  legend2->Draw();
  ceff1->Print("eff_pt16.png");
  ceff1->Print("eff_pt16.pdf");
  ...
  legend2->Draw();
  ceff2->Print("eff_eta16.png");
  ceff2->Print("eff_eta16.pdf");
  ...
  legend2->Draw();
  ceff3->Print("eff_m16.png");
  ceff3->Print("eff_m16.pdf");
