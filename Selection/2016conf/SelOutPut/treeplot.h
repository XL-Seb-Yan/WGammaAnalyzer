...
public :
   ...
   TTreeReaderValue<Float_t> photon_mvaval = {fReader, "photon_mvaval"};
   TTreeReaderValue<Float_t> photon_mvacat = {fReader, "photon_mvacat"};
   ...
   TTreeReaderValue<Float_t> ak8puppijet_massdiff = {fReader, "ak8puppijet_massdiff"};
