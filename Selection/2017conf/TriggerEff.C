...
void TriggerEff(TString era = "All"){
  ...
  //Non stacked plots
  TLegend *legend2 = new TLegend(0.62,0.16,0.87,0.19);
  TAxis *xaxis = NULL;
  TAxis *yaxis = NULL;
  ...
  */
  legend2->Clear();
  legend2->AddEntry(Eff11,"HLT_Photon200","f");
  ...
  */
  legend2->Clear();
  legend2->AddEntry(Eff21,"HLT_Photon200","f");
  ...
  */
  legend2->Clear();
  legend2->AddEntry(Eff31,"HLT_Photon200","f");
